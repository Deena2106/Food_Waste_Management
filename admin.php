...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    header('Location=http://localhost/food/update/login.php');
}
$flage_next = FALSE;
                        ...
                        <td>
                            <div class="row-canv" style="background-color:#add8e6;">
                                ...
                                <div class="row-canv-cont" style="background-color:white;">
                                    ...
                                    <div class="desp">
                                        <a class="ad"><?php echo $row['description'] ?></a>
                            ...
                            <form method="post">
                                ...
                                <button type="submit" class="delete" onclick="mydelete()" >Delete</button>
                            </form>
                            <script>
                                function mydelete(){
