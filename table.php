...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    header('Location:http://localhost/food/update/');
  }
$flage_next = FALSE;
...
$sql = "Select * from `food` group by due_time,issue_date";
    ...
    <div class="wrapper">
        <div class="container" style="width: 250px;">
            ...
            <i class="fa-solid fa-house">
                <ul>
                    <li><a href="table.php" style="background-color: #fff;color: #0c7db1;"><span class="icon"><i class="fa fa-home fa-fw" style="color: #0c7db1;"></i></span><span class="item">HOME</span></a></li>
                    ...
                    <li><a href="index.php"><i class="fa-regular fa-right-from-bracket">Logout</a></li>
                </ul>
        </div>
    </div>
    <div class="form-group">
        <button type="submit" style="border: none; cursor:pointer;">
            <a align="start" type="button" class="date_btn" style="color: #ffff;">
                <?php echo date("F") ?> Day
                <?php echo date(" d ") ?>
                <?php
